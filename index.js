...
app.post('/api/importar-menu', upload.array('menuFile', 10), async (req, res) => {
    ...
    { type: "text", text: "Analiza detalladamente este menú colombiano. Extrae cada plato respetando estrictamente estas reglas:\n1. CERO CATEGORÍAS GENÉRICAS: Está PROHIBIDO crear una categoría llamada 'Combos' o similares. Todo debe ir en su categoría principal (ej: 'Pollo Broaster', 'Arroz Paisa').\n2. TRATAMIENTO DE GASEOSAS Y ADICIONES: NUNCA crees un ítem suelto llamado solo 'Gaseosa' o '1 Gaseosa 250ml'. Si un plato tiene una opción con gaseosa abajo o al lado (ej: '+ 1 Gaseosa 250ml ----- $20.000'), debes unificarlo en UN SOLO NOMBRE COMPLETO para el plato (ej: 'Personal + 1 Gaseosa 250ml') con su precio total correspondiente, o meterlo en la descripción del plato principal. El producto principal y su combo con gaseosa deben ser entradas claras y completas.\nDevuélvelo estrictamente en un JSON con la estructura: {\"productos\": [{\"categoria\": \"Nombre Categoria\", \"nombre\": \"Nombre del Plato o Combo Completo\", \"precio\": 20000, \"descripcion\": \"Detalles o ingredientes\"}]}. Usa 0 si no hay precio." }
];
