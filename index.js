...
app.post('/api/importar-menu', upload.array('menuFile', 10), async (req, res) => {
    ...
    { type: "text", text: "Analiza detalladamente este menú. Extrae ABSOLUTAMENTE TODOS los platos, porciones y combos sin dejar ninguno por fuera. Sigue estas reglas estrictas:\n1. CATEGORÍAS OBLIGATORIAS: Asigna a cada plato la categoría principal a la que pertenece según la sección del menú (ej: 'Pollo Broaster', 'Arroz Paisa', etc.). ESTÁ PROHIBIDO crear una categoría nueva o pestaña llamada 'Combos', 'Promociones' o 'Combo #1'. Si un combo pertenece al arroz paisa, su categoría DEBE ser 'Arroz Paisa'.\n2. NOMBRES Y PRECIOS: Extrae el nombre completo del plato o tamaño (ej: 'Personal', 'Familiar 4 Personas', '1 Pollo Broaster') y su precio real exacto. Si hay opción con gaseosa, agrégala claramente en el nombre o descripción con su precio respectivo.\nDevuélvelo estrictamente en un JSON: {\"productos\": [{\"categoria\": \"Nombre de la Seccion Principal\", \"nombre\": \"Nombre del Plato o Combo\", \"precio\": 20000, \"descripcion\": \"Detalles\"}]}." }
];
