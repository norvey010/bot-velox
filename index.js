...
app.post('/api/importar-menu', upload.array('menuFile', 10), async (req, res) => {
    ...
    { type: "text", text: "Analiza detalladamente este menú. Extrae cada plato y combo respetando estrictamente estas reglas:\n1. CERO CATEGORÍAS GENÉRICAS: Está PROHIBIDO crear una categoría llamada 'Combos', 'Promociones' o similares. Todo plato o combo DEBE pertenecer obligatoriamente a su categoría principal correspondiente (ej: si es un combo de pollo broaster, su categoría debe ser 'Pollo Broaster'; si es de arroz, su categoría debe ser 'Arroz Paisa').\n2. PRECIOS: Si un plato o combo tiene opción sola y opción con gaseosa, crea un ítem separado para cada uno con su nombre claro (ej: 'Especial 6 Personas' y 'Especial 6 Personas + Gaseosa 1.5Lt') asignando el precio real exacto que figura al lado de cada opción.\nDevuélvelo estrictamente en un JSON con la estructura: {\"productos\": [{\"categoria\": \"Nombre Categoria Principal\", \"nombre\": \"Nombre del Plato o Combo\", \"precio\": 15000, \"descripcion\": \"Detalle opcional\"}]}. Usa 0 si no hay precio." }
];
